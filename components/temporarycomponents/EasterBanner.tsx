...
const EasterBanner = () => {
  ...
  const dictionaryLinkTranslation = t(`easter_banner.box_easter_dictionary_anchor.${getCountryVariant()}`);
  const kidsLinkTranslation = t(`easter_banner.box_easter_kids_anchor.${getCountryVariant()}`);
